...
**  $Id: tconnapi.c,v 1.3 2009/03/11 08:58:30 hardway Exp $
**  @author $Author: hardway $
**  @date $Date: 2009/03/11 08:58:30 $
...
extern unsigned char g_szMetalib_tframehead[];
...
int tconnapi_initialize(const char *a_pszGCIMKey, int a_iBusinessid)
{
	...
	gs_pstLib				=	(LPTDRMETALIB) g_szMetalib_tframehead;

	g_pstConnapiFrameHead	=       tdr_get_meta_by_name(gs_pstLib, tdr_get_metalib_name(gs_pstLib));
