...
**  $Id: tqqapi.h,v 1.17 2009/04/01 02:17:41 hardway Exp $
**  @author $Author: hardway $
**  @date $Date: 2009/04/01 02:17:41 $
...
*Function parameter: 
*IN         a_hQQClt:connection handle
*IN         a_pstHead: null means send package head type  is  None
...
*IN          a_iTimeout:send timeout (Generally set to 500 can do,if network crowed,prolong to 1000 or more) unit:millisecond
*return value:
